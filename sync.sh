...
greymatter get catalog-mesh my-mesh | python3 catalog_mesh_script.py $PWD/my-mesh
greymatter list catalog-service | python3 catalog_service_script.py $PWD/my-mesh
